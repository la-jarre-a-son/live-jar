...
const configuration: webpack.Configuration = {
  ...
  entry: {
    main: [path.join(webpackPaths.srcRendererPath, 'main.tsx')],
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: 'main.html',
      chunks: ['main'],
      template: path.join(webpackPaths.srcRendererPath, 'main.ejs'),
      publicPath: './',
      minify: {
    ...
    new HtmlWebpackPlugin({
      filename: 'child.html',
      chunks: ['child'],
      template: path.join(webpackPaths.srcRendererPath, 'child.ejs'),
      publicPath: './',
      minify: {
        collapseWhitespace: true,
        removeAttributeQuotes: true,
